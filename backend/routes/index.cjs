...
// Portfolio and UI/application routes
...
// mount('/maintenance', './maintenance.routes.cjs', 'Maintenance');
...
router.use((req, res) => {
  res.status(404).json({
    success: false,
    message: `مسیر یافت نشد: ${req.originalUrl}`
  });
});
