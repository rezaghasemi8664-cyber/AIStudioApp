...
const USER_SELECT={
  id:true,username:true,email:true,passwordHash:true,passwordEncrypted:true,passwordChangedAt:true,name:true,firstName:true,lastName:true,phone:true,mobile:true,nationalId:true,bio:true,avatar:true,
...
const PUBLIC_SELECT={...USER_SELECT,passwordHash:false,passwordEncrypted:false,passwordChangedAt:false};
