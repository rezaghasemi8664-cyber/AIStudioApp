  ...
  return (
    <>
      ...
      <div className={`app-shell min-h-screen text-[var(--app-color)] flex flex-col p-3 sm:p-4 lg:p-6 transition-colors duration-300 ${!isOnline && !currentUser.isAdmin ? 'pt-12' : ''}`}>
        ...
        <nav className="app-nav w-full min-w-0 mb-4 sm:mb-6" aria-label="ناوبری اصلی"><div className="app-nav-scroll w-full min-w-0 flex flex-nowrap items-center overflow-x-auto overflow-y-hidden overscroll-x-contain whitespace-nowrap border-b border-gray-200 dark:border-gray-700 [scrollbar-width:thin] [-webkit-overflow-scrolling:touch]">
