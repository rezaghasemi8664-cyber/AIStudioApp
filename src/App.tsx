  ...
  return (
    <>
      ...
      <div className={`app-shell min-h-screen text-[var(--app-color)] flex flex-col p-3 sm:p-4 lg:p-6 transition-colors duration-300 ${!isOnline && !currentUser.isAdmin ? 'pt-12' : ''}`}>
        ...
        {activeTab === 'dashboard' && <header data-style-id="header" data-style-name="هدر اصلی" className="app-header flex items-center justify-between px-3 sm:px-5 py-3 border-b mb-4" style={{ backgroundColor: 'var(--header-bg)', borderColor: 'var(--header-border-color)' }}>
